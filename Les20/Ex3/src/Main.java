...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Student> graduatedStudents = students.stream()
                .filter(student-> examPassedNames.contains(student.getFullName())/* проверка, что студент успешно сдал экзамен */)
                .map(student -> {student.groupName = groupNames.get(student.entranceYear);
                return student;}/* заполнение названия группы студента */)
