...
public class Main {private static final Scanner scanner = new Scanner(System.in);
    ...
    private static void addUser() {
        ...
        // добавьте отлов исключений exceptions.ValidateNameException и exceptions.ValidatePasswordException
        // закройте хранилище
        try {
            storage.open();
            ...
            System.out.println("Ошибка работы с  : " + e.getMessage());
        }finally {
            storage.close();
        }
    }
    ...
    private static void showUserPassword() {
        final PasswordStorage storage = new PasswordMemoryStorage();
        // добавьте отлов исключения exceptions.ValidateNameException
        // закройте хранилище
        try {
            storage.open();
            System.out.println("Введите имя пользователя => ");
